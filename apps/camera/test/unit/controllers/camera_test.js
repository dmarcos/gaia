...
suite('controllers/camera', function() {
  ...
  suiteSetup(function(done) {
    ...
    require([
      ...
      View, Settings, Setting, FilmStrip, Storage, ViewFinder) {
  ...
  setup(function() {
    ...
    this.app.views = {
      ...
      viewfinder: sinon.createStubInstance(this.ViewFinder)
    };
  ...
  suite('CameraController#onSettingsConfigured()', function() {
    test('Should set the MaxFileSize based on picture width'
      'and height', function() {
  ...
  suite('CameraController#setPictureSize()', function() {
    test('Should resize the preview only when picture mode', function() {
      this.app.settings.mode.is.withArgs('picture').returns(true);
      this.controller = new this.CameraController(this.app);
      this.controller.setPictureSize(1000);
      assert.isTrue(this.app.camera.setPictureSize.calledWith(1000));
  ...
  suite('CameraController()#setRecorderProfile   ', function() {
    ...
    test('Should setRecorderProfile . Should resize the preview'
      'only when picture mode ', function() {
  ...
  suite('CameraController()#onBlur', function() {
    ...
    test('Should onBlur Only in secure mode filmstrip should'
      'be cleared', function() {
